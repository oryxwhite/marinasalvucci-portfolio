    ...
    <div>
      ...
      <Hero />
       ...
       <PortfolioItem name='Lyra' source={'lyrasc'}
        description={["An interactive audio collage built on community submitted content.  Built with the", <strong> MERN </strong>, "stack using ",<strong>Tone.JS </strong>,  "and ", <strong>Bootstrap</strong> ]}
       alt='lyra screenshot'

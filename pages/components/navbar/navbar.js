...
export default function Navbar() {
  ...
  <nav onClick={() => setIsOpen(!isOpen)} className="relative container mx-auto">
    <div className="flex justify-end container mx-auto mt-10 px-10 -space-x-[3.2rem]">
     ...
     <div className='flex flex-row justify-end mx-28 space-x-[2.4rem] -mt-[10px] font-serif'>

...
export default function Navbar() {
  ...
  <nav onClick={() => setIsOpen(!isOpen)} className="relative container mx-auto">
    <div className="flex justify-end container mx-auto mt-[48px] px-10 -space-x-[3.2rem]">
     ...
     <div className='flex flex-row justify-end mx-[94px] space-x-[2.4rem] -mt-[10px] font-serif'>
        <motion.a animate={isOpen ? { opacity: 1} : { opacity: 0}} transition={{duration: .2, ease: 'easeInOut'}} className='text-white hover:text-[#2a69b6]'>ABOUT</motion.a>

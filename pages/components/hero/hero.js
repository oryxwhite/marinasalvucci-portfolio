...
export default function Hero() {
    return(
        <div className='block mt-12 w-11/12 max-w-[670px] justify-center items-center'>
            ...
            <h2 className='mt-[1.2em] text-center text-[2.6em] font-[800] text-white tracking-[.3em] font-serif'>            
                Marina Salvucci
            </h2>
            <div className=' flex items-center justify-center' >
                <h2 className='relative items-center mt-5 z-10 text-[1.6em] text-center tracking-[.3em] font-serif text-white '>
